...
class ParsedWBFW:
    ...
    def parse_wbfw(self, fw_fpath):
        ...
        self._info_values, data_values = u16_regs[: self.INFO_BLOCK_LENGTH_U16_REGS], u16_regs[self.INFO_BLOCK_LENGTH_U16_REGS :]
        ...
        self._data_chunks = [data_values[i : i + self.DATA_BLOCK_LENGTH_U16_regs] for i in range(0, len(data_values), self.DATA_BLOCK_LENGTH_U16_regs)]
